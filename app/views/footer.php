                ...
                <div class="footer footer_bottom">
                    ...
                    <div class="footer-col">
                        ...
                        <div class="footer-col-content">
                            <ul class="social">
                                <li>
                                    <a href="#" class="fb"><img src="<?php echo APP_URL?>public/image/Fb.png">Facebook</a>
                                </li>
                                <li>
                                    <a href="#" class="fb"><img src="<?php echo APP_URL?>public/image/Gg.png">Google</a>
                                </li>
                            </ul>
                            <div class="clear"></div>
                        </div>
            ...
            <div class="bg_in">
                <div class="footer">
                    <div class="infor_company">
                        ...
                        <a href=""><img src="<?php echo APP_URL?>public/image/da-dang-ky-voi-bo-cong-thuong.png" alt="da-dang-ky-voi-bo-cong-thuong.png" class="cangiua" /></a>
    ...
    <script defer type="text/javascript" src="<?php echo APP_URL?>public/js/jquery.flexslider-min.js"></script>
    <script defer src="<?php echo APP_URL?>public/js/owl.carousel.min.js" type="text/javascript"></script>
    <script defer src="<?php echo APP_URL?>public/js/jquery.lazyload.min.js" type="text/javascript"></script>
    ...
    <footer>
      ...
      <script defer type="text/javascript" src="<?php echo APP_URL?>public/js/sweet-alert.js"></script>
      <script defer type="text/javascript" src="<?php echo APP_URL?>public/js/jquery.flexslider-min.js"></script>
      <script defer src="<?php echo APP_URL?>public/js/owl.carousel.js" type="text/javascript"></script>
      <script defer src="<?php echo APP_URL?>public/js/jquery.lazyload.min.js" type="text/javascript"></script>
      <script defer type="text/javascript" src="<?php echo APP_URL?>public/js/script_ex.js"></script>
      <script defer type="text/javascript" src="<?php echo APP_URL?>public/js/script_menu.js"></script>
    ...
    <div style="height: 1840px;position: fixed;width: 100%;top: 0px;left: 0px;right: 0px;bottom: 0px;z-index: 1001;background: #000 none repeat scroll 0% 0%;opacity: 0.3;display: none;text-align:center" id="khungnen"></div>
    <div style="display: none;left: 70%;margin-left: -309px;z-index: 1002;position: fixed;top: 40%;margin-top: 0px;" id="loadding">
        <img src="<?php echo APP_URL?>public/image/loader.gif" />
    </div>
</body>
